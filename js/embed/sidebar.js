...
(function (root, factory) {
    ...
    Sidebar.prototype = /* @lends WallStreetCN.embed.Sidebar.prototype */ {
        _baseURL: 'http://markets.wallstreetcn.com/embed/sidebar2',
        /**
         * 渲染
         */
        render: function () {
            ...
            if (typeof self.iframeId === 'string') {
                iframe.setAttribute('id', self.parentId);
            }
        ...
        _generateURL: function (options) {
            ...
            return self._baseURL + '?_=' + self._base64_encode(JSON.stringify(options), true);
